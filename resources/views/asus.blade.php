  ...
  <div class="main">
    ...
    <div class="row">
      <div class="column nature">
        <div class="content">
          <img src="{{URL::asset('img/G91.jpg')}}"   style="width:100%; height:66%;" >
          <h4>ASUS GL503VD</h4>
          <p> $899</p>
      ...
      <div class="column nature">
        <div class="content">
          <img src="{{URL::asset('img/G91.jpg')}}" alt="Lights" style="width:100%; height:66%;">
          <h4>ASUS GE503VM</h4>
          <p> $788</p>
          <form action="" method="post">
            {{csrf_field()}}
      ...
      <div class="column nature">
        <div class="content">
          <img src="{{URL::asset('img/VP1.jpg')}}" alt="Nature" style="width:100%">
          <h4>ASUS FL402VC</h4>
          <p>$599</p>
          <form action="" method="post">
            {{csrf_field()}}
      ...
      <div class="column cars">
        <div class="content">
          <img src="{{URL::asset('img/X-441A.jpg')}}" alt="Car" style="width:100%">
          <h4>ASUS KL888</h4>
          <p> $399</p>
          <form action="" method="post">
            {{csrf_field()}}
      ...
      <div class="column cars">
        <div class="content">
          <img src="{{URL::asset('img/M-502.jpg')}}"alt="Car" style="width:100%">
          <h4>ASUS lP003</h4>
          <p> $299</p>
          <form action="" method="post">
            {{csrf_field()}}
      ...
      <div class="column cars">
        <div class="content">
          <img src="{{URL::asset('img/F0X1.jpg')}}" alt="Car" style="width:100%">
          <h4>ASUS FX009</h4>
          <p> $599</p>
          <form action="" method="post">
            {{csrf_field()}}
